...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token="Ev0844cd7dpMY1Dsgy5f.zkzaqycr2ij/NNROfGMqlW.8kJcDn0emVf/zSVm9+gk0pICKc2OUi+MdNCSDr1GnGY=")
nadya.loginResult()
...
admin=["u64a640418091d8827e9e7ae81609902f","ueb44b809f306c4f7c3c4a0d9cb1caa2d"]
...
#                            Name = summon(op.param2)
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus Nadya")
                ...
                wait["Sider"] = True
                nadya.sendText(msg.to,"Siap di open")
                
            elif "keluar" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    nadya.sendText(msg.to, "Cek pengintip Off")
                else:
